...
class task1_2(object):
 	def __init__(self):
		...
		self.h, self.w  = 480, 640#704, 1280
		self.n_class = 3
		model_dir = "/home/arg/jacky/catkin_ws/src/task1_2/models/pineapple_simulation_pick"   # 
		model_name = "FCNs_si2019_batch5_epoch499_RMSprop_lr0.0001.pkl"
	...
	def prediction_cb(self, req):
		...
		im_msg = rospy.wait_for_message('/zed/zed_node/rgb/image_rect_color', Image, timeout=None)
		resp.pc = rospy.wait_for_message('/zed/zed_node/point_cloud/cloud_registered', PointCloud2, timeout=None)
		...
		origin  = img
		cv2.imwrite("/home/arg/Pictures/origin.jpg", origin)

		#img     = img[:704,:,:]
		img     = img[:, :, ::-1]  # switch to BGR
		cv2.imwrite("/home/arg/Pictures/image.jpg", img)
		...
		cv2.imwrite("/home/arg/Pictures/mask.jpg", mask)
		#cv2.imwrite("/home/arg/Desktop/mask.jpg", mask) 
		print(count)
		return resp

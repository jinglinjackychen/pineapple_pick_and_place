...
class calibration{
 private:
  ...
  bool get_tag_data(tf::StampedTransform &t){
    try{
      listener.waitForTransform("zed_left_camera_frame", tag_frame, ros::Time(0), ros::Duration(2.0));
      listener.lookupTransform("zed_left_camera_frame", tag_frame, ros::Time(0), t);
      //listener.waitForTransform("camera_color_frame", tag_frame, ros::Time(0), ros::Duration(2.0));
      //listener.lookupTransform("camera_color_frame", tag_frame, ros::Time(0), t);

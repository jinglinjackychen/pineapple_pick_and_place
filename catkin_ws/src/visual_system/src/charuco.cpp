...
int main(int argc, char** argv)
{
  ...
  message_filters::Subscriber<sensor_msgs::Image> image_sub(pnh, "/camera/color/image_rect_color", 1);
  message_filters::Subscriber<sensor_msgs::CameraInfo> info_sub(pnh, "/camera/color/camera_info", 1);
